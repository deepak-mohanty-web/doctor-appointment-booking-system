  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row mb-20">
        <div className="border px-10 md:px-16 py-6 md:py-16 flex flex-col gap-4 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer">
          <b>EFFICIENCY:</b>
          <p>
